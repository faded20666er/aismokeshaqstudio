...
export default async function handler(req, res) {
  try {
    ...
    // submits — see middleware/rateLimit.js. Shares the "generation"
    // bucket with generate/lipsync/voice/music so the limit is a single
    // per-account submit budget across all generation types, not five
    // separate ones a script could round-robin through.
