...
export default async function handler(req, res) {
  try {
    ...
    //
    // WaveSpeed talking-photo models (InfiniteTalk) don't have a flat
    // cost — pricing scales with requested duration (their real rate:
    // $0.03/sec at 480p, $0.06/sec at 720p, 5s minimum). The frontend
    // sends inputs.durationSeconds when using one of these models.
    // ---------------------------------------------------------
